    ...
    <div className='fixed top-0 left-0 w-full bg-opacity-70 backdrop-blur-md z-50'>
        <div className='max-w-[1950px] mx-auto flex justify-between text-gray-200 text-xl items-center pl-0 pr-4 md:pl-0 md:pr-12 h-20'>
            <a href="#" className='flex items-center'>
                <img src={logo} alt="Logo" className='h-12 w-12 mr-2' /> {/* Increased size */}
                <span className='text-2xl md:text-2xl font-bold'>Aleksi Valioghli | Software Engineer</span> {/* Increased size and bold */}
            </a>
            ...
            >
                <ul className='font-semibold text-4xl space-y-8 mt-24 text-center'>
                    ...
                    <li><Link to="projects" onClick={closeNav} smooth={true} offset={50} duration={500}>Project</Link></li>
